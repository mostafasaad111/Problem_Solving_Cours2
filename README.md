...
## 2- Write a program to read N elements and store them in the array then print all array elements and ask
## for a number to check, then print how many numbers a certain element repeated in that array.
...
## 10 - Write a program to fill array two arrays with max size 100 with random numbers from 1 to 100 , sum 
## their elements in a third array and print the results.
